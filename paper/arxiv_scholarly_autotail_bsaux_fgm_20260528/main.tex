...
\input{tables/main_results_journal.tex}
\end{table}
...
\label{tab:sig_cost}
\input{tables/significance_and_cost.tex}
\end{table}
...
\input{tables/category_delta_analysis.tex}
\end{table}
